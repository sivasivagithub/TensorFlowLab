...
It should happen in less than 20 epochs, so it's ok to hard code the number of epochs for training, but your training must end once it hits the above metric.
...
def train_mnist_conv():
    ...
    test_images = test_images(10000, 28, 28, 1)
